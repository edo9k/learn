...
section .data ; response string
  response db 'HTTP/1.1 200 OK', 0dh, 0ah, 'Content-Type: text/html', 0dh, 0ah, 'Content-Length: 22', 0dh, 0ah, 0dh, 0ah, '<h1>Hello, World!</h1>', 0dh, 0ah, 0h
 
 ;  0dh, 0ah, 'Content-Type: text/html',   
 ;  0dh, 0ah, 'Content-Length: 22', 
 ;  0dh, 0ah, 
 ;  0dh, 0ah, '<h1>Hello, World!</h1>',
 ;  0dh, 0ah, 0h
...
_write:       ; write socket (lesson 34)
  mov edx, 86  ; length of bytes to write
